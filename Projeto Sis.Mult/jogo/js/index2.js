...
playGame.prototype = {
  ...
  create: function() {
    ...
    game.time.events.repeat(Phaser.Timer.SECOND * 1, 10, moveDroid, game);
    ...
    // game.time.events.repeat(Phaser.Timer.SECOND * 3, 10, moveDroid(droidsprite1), game);
    ...
    // game.time.events.repeat(Phaser.Timer.SECOND * 3, 10, moveDroid(droidsprite2), game);
